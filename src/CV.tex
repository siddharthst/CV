...
%----------------------------------------------------------------------------------------
\PassOptionsToPackage{a4paper, margin=0.5in}{geometry}
...
\NewEntry{email}{\href{mailto:siddhartht.94@gmail.com}{siddhartht.94@gmail.com}} % Email address
...
\NewEntry{StackExchange}{\href{https://stackexchange.com/users/4437426/siddharth}{Siddharth}} % Personal website
...
\spacedlowsmallcaps{Other}\vspace{1em}
...
\vspace{-2.5mm}
\Description{\MarginText{Life Science}DNA isolation, RNA isolation, Plasmid and genomic DNA isolation, PCR, Sanger and Illumina sequencing}
